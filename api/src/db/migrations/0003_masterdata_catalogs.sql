...
ALTER TABLE "phuong_xa_legacy" ADD CONSTRAINT "phuong_xa_legacy_tinh_id_tinh_id_fk" FOREIGN KEY ("tinh_id") REFERENCES "public"."tinh"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "phuong_xa_legacy" ADD CONSTRAINT "phuong_xa_legacy_quan_id_quan_id_fk" FOREIGN KEY ("quan_id") REFERENCES "public"."quan"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
