...
export function TodayReceiptsTile({ count, trend }: TodayReceiptsTileProps) {
  ...
  return (
    <Card className="border-indigo-200 bg-indigo-50 dark:border-indigo-500/25 dark:bg-indigo-500/10">
      <CardContent className="p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-3xl font-bold tabular-nums text-indigo-900 dark:text-indigo-100">
              {count}
            </p>
          ...
          <div className="shrink-0 rounded-lg bg-indigo-100 p-2.5 dark:bg-indigo-500/20">
            <ClipboardList
