...
export const NHAN_VIEN_ROWS: NhanVien[] = Array.from({ length: 40 }, (_, i) => {
  ...
  return {
    ...
    ngaySinh: rng.bool(0.8)
      ? rng.isoDateWithin(365 * 35, MOCK_REFERENCE_NOW - 365 * 20 * 86_400_000)
      : undefined,
    ...
    ngayLamViec: rng.isoDateWithin(1200, MOCK_REFERENCE_NOW),
    ...
    ngayCap: rng.bool(0.7)
      ? rng.isoDateWithin(2000, MOCK_REFERENCE_NOW)
      : undefined,
    ...
    createdAt: rng.isoDateWithin(400, MOCK_REFERENCE_NOW),
    updatedAt: rng.bool(0.3)
      ? rng.isoDateWithin(60, MOCK_REFERENCE_NOW)
      : undefined,
  }
})
